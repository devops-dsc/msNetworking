...
{    
   ...
   {        
      ...
      $getTargetResourceResult.Ensure = ($Ensure = "Absent")
      
      return $getTargetResourceResult
   }
   
   #$getTargetResourceResult.Ensure = ($Ensure -eq "Present")
   $getTargetResourceResult.Ensure = ($Ensure = "Present")
   ...
   foreach ($firewallRule in $firewallRules)
   {
      ...
      )
      {
         ...
         $getTargetResourceResult.DisplayGroup = $DisplayGroup
         $getTargetResourceResult.State = $State
         $getTargetResourceResult.Profile = $Profile
         $getTargetResourceResult.Direction = $Direction
         $getTargetResourceResult.Access = $Access
         $getTargetResourceResult.RemotePort = $RemotePort
         $getTargetResourceResult.LocalPort = $LocalPort
         $getTargetResourceResult.Protocol = $Protocol
         $getTargetResourceResult.Description = $Description
         #$getTargetResourceResult.AppicationPath = $ApplicationPath
         $getTargetResourceResult.Service = $Service
      }
   }
