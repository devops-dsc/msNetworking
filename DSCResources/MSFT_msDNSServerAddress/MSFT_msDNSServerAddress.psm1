<#######################################################################################
 #  msDnsServerAddress : DSC Resource that will set/test/get the current DNS Server
 #  Address, by accepting values among those given in msDnsServerAddress.schema.mof
 #######################################################################################>
